...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-base-special-trunc2/tags). For example,

```javascript
trunc2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-trunc2@v0.3.0-umd/browser.js' )
```
